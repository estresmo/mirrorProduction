 ...
 */
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) && "undefined" != typeof module ? t(exports, require("jquery")) : "function" == typeof define && define.amd ? define(["exports", "jquery"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).adminlte = {}, e.jQuery);
}(void 0, function (e, t) {
  "use strict";

  function a(e) {
    return e && "object" == (0, _typeof2["default"])(e) && "default" in e ? e : {
      "default": e
    };
  }
  ...
  var u = "CardWidget",
    ...
    return t.collapse = function () {
      ...
      a || (a = new e(n["default"](this), i), n["default"](this).data(c, "string" == typeof t ? a : t)), "string" == typeof t && /collapse|expand|remove|toggle|maximize|minimize|toggleMaximize/.test(t) ? a[t]() : "object" == (0, _typeof2["default"])(t) && a._init(n["default"](this));
    }, e;
  }();
  ...
  var ae = "Fullscreen",
    ...
    return t.toggle = function () {
      ...
      var i = n["default"].extend({}, se, "object" == (0, _typeof2["default"])(t) ? t : a),
          o = new e(n["default"](this), i);
      n["default"](this).data(ne, "object" == (0, _typeof2["default"])(t) ? t : a), "string" == typeof t && /toggle|toggleIcon|fullscreen|windowed/.test(t) ? o[t]() : o.init();
    }, e;
  }();
  ...
  var de = "lte.iframe",
    ...
    return t.onTabClick = function (e) {
      ...
      if (n["default"](ue).length > 0) {
        ...
        a || (a = n["default"](this).data());
        var i = n["default"].extend({}, ke, "object" == (0, _typeof2["default"])(t) ? t : a);
        localStorage.setItem("AdminLTE:IFrame:Options", JSON.stringify(i));
        var o = new e(n["default"](this), i);
        n["default"](this).data(de, "object" == (0, _typeof2["default"])(t) ? t : a), "string" == typeof t && /createTab|openTabSidebar|switchTab|removeActiveTab/.test(t) && o[t]();
  ...
  var Xe = "SidebarSearch",
    ...
    return a.init = function () {
      ...
      a || (a = n["default"](this).data());
      var i = n["default"].extend({}, ut, "object" == (0, _typeof2["default"])(t) ? t : a),
          o = new e(n["default"](this), i);
      n["default"](this).data(Ye, "object" == (0, _typeof2["default"])(t) ? t : a), "string" == typeof t && /init|toggle|close|open|search/.test(t) ? o[t]() : o.init();
    }, e;
  }();
  ...
  var Qt = "TodoList",
    ...
    return t.toggle = function (e) {
      ...
      return this.each(function () {
        ...
        a || (a = n["default"](this).data());
        var i = n["default"].extend({}, Et, "object" == (0, _typeof2["default"])(t) ? t : a),
            o = new e(n["default"](this), i);
        n["default"](this).data(Ht, "object" == (0, _typeof2["default"])(t) ? t : a), "init" === t && o[t]();
      });
    }, e;
  }();
  ...
  }, e.CardRefresh = f, e.CardWidget = I, e.ControlSidebar = M, e.DirectChat = P, e.Dropdown = V, e.ExpandableTable = te, e.Fullscreen = re, e.IFrame = Qe, e.Layout = Me, e.NavbarSearch = wt, e.PushMenu = Ke, e.SidebarSearch = ht, e.Toasts = kt, e.TodoList = Lt, e.Treeview = $t, Object.defineProperty(e, "__esModule", {
    value: !0
  });
});