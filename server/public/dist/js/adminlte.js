...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('jquery')) : typeof define === 'function' && define.amd ? define(['exports', 'jquery'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.adminlte = {}, global.jQuery));
  ...
  var Fullscreen = /*#__PURE__*/function () {
    ...
    Fullscreen._jQueryInterface = function _jQueryInterface(config) {
      ...
      var _options = $__default['default'].extend({}, Default$8, (0, _typeof2["default"])(config) === 'object' ? config : data);

      var plugin = new Fullscreen($__default['default'](this), _options);
      $__default['default'](this).data(DATA_KEY$8, (0, _typeof2["default"])(config) === 'object' ? config : data);
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    IFrame._jQueryInterface = function _jQueryInterface(config) {
      if ($__default['default'](SELECTOR_DATA_TOGGLE$1).length > 0) {
        ...
        var _options = $__default['default'].extend({}, Default$7, (0, _typeof2["default"])(config) === 'object' ? config : data);

        localStorage.setItem('AdminLTE:IFrame:Options', JSON.stringify(_options));
        var plugin = new IFrame($__default['default'](this), _options);
        $__default['default'](this).data(DATA_KEY$7, (0, _typeof2["default"])(config) === 'object' ? config : data);
  ...
  var SidebarSearch = /*#__PURE__*/function () {
    ...
    SidebarSearch._jQueryInterface = function _jQueryInterface(config) {
      ...
      var _options = $__default['default'].extend({}, Default$4, (0, _typeof2["default"])(config) === 'object' ? config : data);

      var plugin = new SidebarSearch($__default['default'](this), _options);
      $__default['default'](this).data(DATA_KEY$4, (0, _typeof2["default"])(config) === 'object' ? config : data);
  ...
  var TodoList = /*#__PURE__*/function () {
    ...
    TodoList._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        ...
        var _options = $__default['default'].extend({}, Default$1, (0, _typeof2["default"])(config) === 'object' ? config : data);

        var plugin = new TodoList($__default['default'](this), _options);
        $__default['default'](this).data(DATA_KEY$1, (0, _typeof2["default"])(config) === 'object' ? config : data);
